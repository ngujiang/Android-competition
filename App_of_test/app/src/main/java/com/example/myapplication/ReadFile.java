...
public class ReadFile {
    ...
    public ReadFile(String labelFileName, String imageFileName, Context context) {
    ...
    public List<DigitImage> loadDigitImages() throws IOException {
        ...
        InputStream labelInputStream = context.getResources().getAssets().open(labelFileName);
        InputStream imageInputStream = context.getResources().getAssets().open(imageFileName);
